...
export class FXSwapFactory extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save FXSwapFactory entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type FXSwapFactory must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("FXSwapFactory", id.toString(), this);
    }
  }

  static loadInBlock(id: string): FXSwapFactory | null {
    return changetype<FXSwapFactory | null>(
      store.get_in_block("FXSwapFactory", id),
    );
  }

  static load(id: string): FXSwapFactory | null {
    return changetype<FXSwapFactory | null>(store.get("FXSwapFactory", id));
  }
...
export class Token extends Entity {
  ...
  get isWhitelist(): boolean {
    let value = this.get("isWhitelist");
    if (!value || value.kind == ValueKind.NULL) {
      return false;
    } else {
  ...
  set isWhitelist(value: boolean) {
    this.set("isWhitelist", Value.fromBoolean(value));
  }
...
export class Pair extends Entity {
  ...
  set isTracked(value: boolean) {
    this.set("isTracked", Value.fromBoolean(value));
  }
}
...
export class User extends Entity {
  ...
  get cumulativePoint(): BigDecimal {
    let value = this.get("cumulativePoint");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigDecimal();
  ...
  set cumulativePoint(value: BigDecimal) {
    this.set("cumulativePoint", Value.fromBigDecimal(value));
  }
...
export class FXSwapDayData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save FXSwapDayData entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type FXSwapDayData must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("FXSwapDayData", id.toString(), this);
    }
  }

  static loadInBlock(id: string): FXSwapDayData | null {
    return changetype<FXSwapDayData | null>(
      store.get_in_block("FXSwapDayData", id),
    );
  }

  static load(id: string): FXSwapDayData | null {
    return changetype<FXSwapDayData | null>(store.get("FXSwapDayData", id));
  }
...
export class MasterchefLiquidityUpdate extends Entity {
  ...
  save(): void {
    ...
    assert(
      id != null,
      "Cannot save MasterchefLiquidityUpdate entity without an ID",
    );
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type MasterchefLiquidityUpdate must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("MasterchefLiquidityUpdate", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): MasterchefLiquidityUpdate | null {
    return changetype<MasterchefLiquidityUpdate | null>(
      store.get_in_block("MasterchefLiquidityUpdate", id.toHexString()),
    );
  }

  static load(id: Bytes): MasterchefLiquidityUpdate | null {
    return changetype<MasterchefLiquidityUpdate | null>(
      store.get("MasterchefLiquidityUpdate", id.toHexString()),
    );
  }
  ...
  get accLiquidity(): BigInt {
    let value = this.get("accLiquidity");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set accLiquidity(value: BigInt) {
    this.set("accLiquidity", Value.fromBigInt(value));
  }

  get liquidityValue(): BigDecimal {
    let value = this.get("liquidityValue");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigDecimal();
  ...
  set liquidityValue(value: BigDecimal) {
    this.set("liquidityValue", Value.fromBigDecimal(value));
  }
...
export class MasterchefUser extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save MasterchefUser entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type MasterchefUser must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("MasterchefUser", id.toString(), this);
    }
  }

  static loadInBlock(id: string): MasterchefUser | null {
    return changetype<MasterchefUser | null>(
      store.get_in_block("MasterchefUser", id),
    );
  }

  static load(id: string): MasterchefUser | null {
    return changetype<MasterchefUser | null>(store.get("MasterchefUser", id));
  }
  ...
  get lastLiquidityUpdate(): Bytes | null {
    let value = this.get("lastLiquidityUpdate");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toBytes();
  ...
  set lastLiquidityUpdate(value: Bytes | null) {
    if (!value) {
      this.unset("lastLiquidityUpdate");
    } else {
      this.set("lastLiquidityUpdate", Value.fromBytes(<Bytes>value));
    }
  }
}
